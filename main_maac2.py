...
parser.add_argument('--dbas_iters', type=int, default=10)
parser.add_argument('--dbas_num_samples', type=int, default=100)
parser.add_argument('--dbas_q', type=float, default=0.8)
parser.add_argument('--dbas_n_components', type=int, default=5)
parser.add_argument('--dbas_gmm_iter', type=int, default=50)
...
def add_metric(metric_dict, args):
    ...
    #     os.makedirs(folder)
    file_name = os.path.join(log_dir, 'metrics.json')
    config_name = os.path.join(log_dir, 'config.json')
