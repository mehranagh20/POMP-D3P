...
# setting: eps0.8-ga_lr0.05-iter100-n_critic5-end_iter50-eps_decay_end100000-noisy5-eff1
...
for seed in 4; do
    ...
    save_log_file=${save_dir}/${name}/out.log
     python main_maac2.py --exploration_init --cuda --save_result --save_model \
                ...
                --rollout_max_epoch 305 --env-name HumanoidTruncatedObs-v2 --num_steps 201000 \
